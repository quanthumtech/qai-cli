...
`)
  ...
  while (true) {
    ...
    if (input === "/help") {
      infoLine("")
      infoLine("═══════════════════════════════════════════════════")
      infoLine("                    QAI CLI COMMANDS")
      infoLine("═══════════════════════════════════════════════════")
      infoLine("")
      infoLine(" /doc <descrição>          Gera documentação do projeto")
      infoLine("                           Suporta: .md, .docx, .pdf, .html")
      infoLine("                           Ex: /doc crie documentação em docx")
      infoLine("                           Ex: /doc gere manual em pdf no caminho /docs")
      infoLine("")
      infoLine(" /agents                   Lista todos os agents disponíveis")
      infoLine(" /agents <id>              Troca para um agent específico")
      infoLine("                           Ex: /agents dev")
      infoLine("                           Ex: /agents architect")
      infoLine("")
      infoLine(" /provider                 Lista providers configurados")
      infoLine(" /provider list            Lista providers configurados")
      infoLine(" /provider default <id>    Define provider padrão")
      infoLine("                           Ex: /provider default openai")
      infoLine("                           Providers: anthropic, openai, google, groq, mistral, nvidia")
      infoLine("")
      infoLine(" /model                    Lista modelos disponíveis")
      infoLine(" /model set <provider/model> Troca de modelo")
      infoLine("                           Ex: /model set openai/gpt-4o")
      infoLine("                           Ex: /model set anthropic/claude-sonnet-4-5")
      infoLine("")
      infoLine(" /connect                  Mostra providers disponíveis para conectar")
      infoLine(" /connect <provider> <key> Conecta a um provider com API key")
      infoLine("                           Ex: /connect anthropic sk-ant-...")
      infoLine("")
      infoLine(" /clear                    Limpa o histórico da conversa atual")
      infoLine(" /abort                    Cancela operação em andamento (pressione Esc 2x)")
      infoLine(" exit ou /exit             Sai do QAI")
      infoLine("")
      infoLine("═══════════════════════════════════════════════════")
      infoLine(" Dicas:")
      infoLine(" • Pressione Tab para autocomplete de comandos")
      infoLine(" • Pressione Esc 2x rápido para cancelar resposta")
      infoLine(" • Use / antes dos comandos: /doc, /agents, etc.")
      infoLine("═══════════════════════════════════════════════════")
      console.log()
      continue
    }
